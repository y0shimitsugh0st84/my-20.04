...
apt-get install -y vim wget net-tools locales bzip2 \
    python-numpy vim wget ca-certificates  pulseaudio xrdp\
    ...
    libxml-parser-perl libxml-twig-perl libxml-xpathengine-perl xdg-utils  xserver-xephyr jq tor xarchiver libavcodec-extra vlc #used for websockify/novnc
